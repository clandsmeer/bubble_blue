...
private:
  void odom_callback(const nav_msgs::msg::Odometry & msg)
  {
    ...
    noisy_msg.angular_velocity.x = std::round((msg.twist.twist.angular.x +
        diff_gyro_(rng_generator_) + gyro_bias_.x) / resolution_) * resolution_;
    noisy_msg.angular_velocity.y = std::round((msg.twist.twist.angular.y +
        diff_gyro_(rng_generator_) + gyro_bias_.y) / resolution_) * resolution_;
    noisy_msg.angular_velocity.z = std::round((msg.twist.twist.angular.z +
        diff_gyro_(rng_generator_) + gyro_bias_.z) / resolution_) * resolution_;
