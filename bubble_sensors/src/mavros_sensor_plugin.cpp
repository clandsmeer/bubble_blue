...
MavrosSensorPlugin::MavrosSensorPlugin(mavros::plugin::UASPtr uas_)
: mavros::plugin::Plugin(uas_, "mavros_sensor")
{
  ...
  node_handle->declare_parameter<std::string>("mavros_sensor.sensor_topic",
      "/sensors/generalized_sensor_test");
  node_handle->declare_parameter<std::string>("mavros_sensor.mavros_topic",
      "/mavros/custom_vision_speed/speed_twist");
